  ...
  const accessoryProducts = [
    {
      ...
      "price": 1882,
      "product_id": 190085,
      "image": "https://super.homelane.com/KRI133225_main-1508346189_1_detergent-holder-350mm-.jpg",
      "key": "detergentHolder"
    },
    {
      ...
      "price": 11838,
      "product_id": 190088,
      "image": "https://super.homelane.com/KRI133228_main-1508346816_1_bottle-pull-out-300mm-soft-close-channels-.jpg",
      "key": "bottlePullOut"
    },
    {
      ...
      "price": 18177,
      "product_id": 190089,
      "image": "https://super.homelane.com/KRI133229_main-1508346882_1_tandem-drawer-soft-close-channels-without-gallery.jpg",
      "key": "tandemDrawer"
    },
    {
      ...
      "price": 16244,
      "product_id": 190115,
      "image": "https://super.homelane.com/KRI133255_main-1508336741_1_cutlery-cup-saucer-thali-tray.jpg",
      "key": "cutleryTray"
    },
    {
      "name": "Detergent holder & bin holder designs",
      "price": 1404,
      "product_id": 190116,
      "image": "https://super.homelane.com/KRI133256_main-1508346279_1_detergent-holder-bin-holder.jpg",
      "key": "detergentBinHolder"
    },
    {
      "name": "Plain basket(600mm soft-close channels) designs",
      "price": 18514,
      "product_id": 190086,
      "image": "https://super.homelane.com/KRI133226_main-1508346736_1_plain-basket-600mm-soft-close-channels-.jpg",
      "key": "plainBasket"
    },
    {
      "name": "Plate tray glass tray (600mm) designs",
      "price": 5652,
      "product_id": 190090,
      "image": "https://super.homelane.com/KRI133230_main-1508346918_1_plate-tray-glass-tray-600mm-.jpg",
      "key": "plateTray"
    },
    {
      "name": "D tray designs",
      "price": 38228,
      "product_id": 190091,
      "image": "https://super.homelane.com/KRI133231_main-1508342841_1_d-tray.jpg",
      "key": "dTray"
    },
    {
      "name": "Pantry pullout designs",
      "price": 116335,
      "product_id": 190092,
      "image": "https://super.homelane.com/KRI133232_main-1508344853_1_pantry-pullout.jpg",
      "key": "pantryPullout"
    },
    {
      "name": "Magic corner designs",
      "price": 40341,
      "product_id": 190093,
      "image": "https://super.homelane.com/KRI133233_main-1508345889_1_magic-corner.jpg",
      "key": "magicCorner"
    },
    {
      "name": "Worktop extension designs",
      "price": 33675,
      "product_id": 190094,
      "image": "https://super.homelane.com/KRI133234_main-1508346852_1_worktop-extension.jpg",
      "key": "worktopExtension"
    },
    {
      "name": "Lemans corner designs",
      "price": 44367,
      "product_id": 190095,
      "image": "https://super.homelane.com/KRI133235_main-1508346681_1_lemans-corner.jpg",
      "key": "lemansCorner"
    },
    {
      "name": "Wicker basket (600mm) designs",
      "price": 26413,
      "product_id": 190097,
      "image": "https://super.homelane.com/KRI133237_main-1508346780_1_wicker-basket-600mm-.jpg",
      "key": "wickerBasket"
    },
    {
      "name": "Larder pull out designs",
      "price": 49417,
      "product_id": 190099,
      "image": "https://super.homelane.com/KRI133239_main-1508346943_1_larder-pull-out.jpg",
      "key": "larderPullout"
    },
    {
      ...
      "price": 5900,
      "product_id": 190119,
      "image": "https://super.homelane.com/KRI133259_main-1508345975_1_microwave-and-otg-provision-with-one-shelf-and-one.jpg",
      "key": "microwaveOtg"
    },
    {
      "name": "Pull out baskets designs",
      "price": 8627,
      "product_id": 190120,
      "image": "https://super.homelane.com/KRI133260_main-1508347150_1_pull-out-baskets.jpg",
      "key": "pullOutBaskets"
    }
  ];
    ...
    const kitchenConfig = {
      ...
      wallDimensions: {
        wallA: {
          ...
          height: { feet: Number(wallAHeight), inches: Number(wallAHeightInch) }
        },
        wallB: {
          length: { feet: Number(wallBLength), inches: Number(wallBInch) },
          height: { feet: Number(wallBHeight), inches: Number(wallBHeightInch) }
        },
        wallC: {
          length: { feet: Number(wallCLength), inches: Number(wallCInch) },
          height: { feet: Number(wallCHeight), inches: Number(wallCHeightInch) }
        }
      },
      cabinetMaterial,
      shutterMaterial,
        ...
        <ol role="list" className="space-y-4 md:flex md:space-y-0 md:space-x-8">
          {steps.map((step) => (
            <li key={step.name} className="md:flex-1">
              <div className={`group pl-4 py-2 flex flex-col border-l-4 ${step.id === currentStep ? 'border-red-600' : 'border-gray-200'} hover:border-gray-300 md:pl-0 md:pt-4 md:pb-0 md:border-l-0 md:border-t-4`}>
                <span className={`text-xs font-semibold tracking-wide uppercase ${step.id === currentStep ? 'text-red-600' : 'text-gray-500'}`}>
                  Step {step.id}
                </span>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <p><span className="font-medium">Phone:</span> {userDetails.countryCode} {userDetails.phone}</p>
            <p><span className="font-medium">Address:</span> {userDetails.address}</p>
            <p><span className="font-medium">Pincode:</span> {userDetails.pincode}</p>
            {userDetails.message && (
              <p><span className="font-medium">Additional Notes:</span> {userDetails.message}</p>
            )}
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="space-y-1">
                <p><span className="font-medium">Home Type:</span> {homeConfig}</p>
                <p><span className="font-medium">Kitchen Layout:</span> {kitchenShape}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                <p>
                  <span className="font-medium">Wall A:</span> Length: {wallALength}' {wallAInch}", Height: {wallAHeight}' {wallAHeightInch}"
                </p>
                <p>
                  <span className="font-medium">Wall B:</span> Length: {wallBLength}' {wallBInch}", Height: {wallBHeight}' {wallBHeightInch}"
                </p>
                {kitchenShape === 'U-Shape' && (
                  <p>
                    <span className="font-medium">Wall C:</span> Length: {wallCLength}' {wallCInch}", Height: {wallCHeight}' {wallCHeightInch}"
                  </p>
                )}
              </div>
            </div>
  ...
  const renderThankYouScreen = () => (
    <div className="text-center space-y-6 py-12">
      ...
      <p className="text-gray-600 max-w-md mx-auto">
        Your kitchen estimate request has been successfully submitted. Our team will review your requirements and get back to you shortly.
      </p>
      <div className="mt-8">
        <Button
          onClick={() => {
            ...
            <>
              ...
              <Card>
                <CardHeader className="border-b">
                  <CardTitle className="text-base font-semibold">Step 1 : Home Configuration</CardTitle>
                </CardHeader>
                <CardContent className="pt-6 pb-4">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="1 BHK" id="1bhk" className="text-red-500" />
              ...
              <Card>
                <CardHeader className="border-b">
                  <CardTitle className="text-base font-semibold">Step 2 : Kitchen Shape</CardTitle>
                </CardHeader>
                <CardContent className="pt-6 pb-4">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroup value={kitchenShape} onValueChange={setKitchenShape} className="flex">
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="L-Shape" id="l-shape" className="text-red-500" />
                  ...
                  <div className="mt-8 space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select value={wallAInch} onValueChange={setWallAInch}>
                          ...
                          <SelectContent>
                            {Array.from({length: 12}, (_, i) => i).map(num => (
                              <SelectItem key={`inch-${num}`} value={num.toString()}>
                                {num}
                              </SelectItem>
                            ))}
                          </SelectContent>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span>Feet</span>
                        <Select value={wallAHeightInch} onValueChange={setWallAHeightInch}>
                          <SelectTrigger className="w-28">
                            <SelectValue placeholder="Inch" />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span>Feet</span>
                        <Select value={wallBInch} onValueChange={setWallBInch}>
                          <SelectTrigger className="w-28">
                            <SelectValue placeholder="Inch" />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span>Feet</span>
                        <Select value={wallBHeightInch} onValueChange={setWallBHeightInch}>
                          <SelectTrigger className="w-28">
                            <SelectValue placeholder="Inch" />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span>Feet</span>
                        <Select value={wallCInch} onValueChange={setWallCInch}>
                          <SelectTrigger className="w-28">
                            <SelectValue placeholder="Inch" />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span>Feet</span>
                        <Select value={wallCHeightInch} onValueChange={setWallCHeightInch}>
                          <SelectTrigger className="w-28">
                            <SelectValue placeholder="Inch" />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    >
                      <CarouselContent className="-ml-2 md:-ml-4">
                        {accessoryProducts.map((product) => (
                          <CarouselItem key={product.product_id} className="pl-2 md:pl-4 basis-full md:basis-1/4">
                            <div className="flex flex-col items-center justify-between h-full">
                              ...
                              <p className="text-xs text-center mb-2">{product.name}</p>
                              <div className="flex items-center gap-3">
                                <Button 
                                  variant="outline" 
                                  size="icon"
                                  className="h-8 w-8 border border-gray-300 rounded-l"
                                  onClick={() => decrementAccessory(product.key)}
                                >
                                ...
                                <Button 
                                  ...
                                  onClick={() => incrementAccessory(product.key)}
                                >
                                  <Plus className="h-4 w-4" />
                                </Button>
                              </div>
                              <div className="mt-1 text-xs">₹{product.price}</div>
                            </div>
                          </CarouselItem>
                        ))}
                      </CarouselContent>
