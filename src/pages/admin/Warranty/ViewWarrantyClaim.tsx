...
const ViewWarrantyClaim = ({ claim, isOpen, onOpenChange }: ViewWarrantyClaimProps) => {
        ...
        <div className="grid gap-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{claim.ticketId}</p>
            </div>
