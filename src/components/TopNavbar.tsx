      ...
      <div className="px-12 ">
        <div className="flex justify-between h-14">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/dashboard/refer&earn" className="text-sm text-gray-700 hover:text-red-600 font-normal">
              Refer and Earn
            </Link>
            <Link to="/team" className="text-sm text-gray-700 hover:text-red-600 font-normal">
              Our Team
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="relative group">
              <div className="flex items-center text-sm text-red-600 hover:text-red-700 font-normal cursor-pointer">
              ...
              <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 absolute right-0 z-30 w-48 bg-white shadow-lg rounded-md py-1 transition-all duration-300 ease-in-out">
                <Link to="/contact-us" className="block px-4 py-2 text-sm text-gray-700 hover:text-red-600 font-normal">Contact Us</Link>
              </div>
            </div>
            {accessToken ? (
